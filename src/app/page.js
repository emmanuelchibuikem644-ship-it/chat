...
const CAROUSEL_ITEMS = [
  {
    quote: "Some of the deepest wounds are the ones no one else can see.",
  ...
  {
    quote: "You don't have to carry the weight of the world alone. Even the strongest hearts need rest.",
  ...
  {
    quote: "Healing isn't about forgetting what hurt you—it's about learning that your story isn't over.",
    name: "Words of Hope",
    mood: "Recovery",
    color: "#f0ebe8",
    accent: "#b08a7a",
  ...
  {
    quote: "It's okay to pause, to cry, and to begin again. Growth often starts in silence.",
    name: "Inner Strength",
    mood: "Resilience",
    color: "#e8edf0",
    accent: "#7a9ab0",
  ...
  {
    quote: "One kind word can keep a heart going when everything else feels heavy. Never underestimate your light.",
    name: "A Little Hope",
    mood: "Comfort",
    color: "#f0ede8",
    accent: "#b0a07a",
